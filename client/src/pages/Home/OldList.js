...
function OldList({ name, isLoading, campaigns }) {
  ...
  return (
    <div ref={ref} className="pt-12 pb-12 xl:pl-36 xl:pr-36 lg:pl-20 lg:pr-20 md:pl-16 md:pr-16 sm:pl-8 sm:pr-8 pl-8 pr-8">
      ...
      <div className="flex flex-row w-full justify-center">
      <div className="mt-2 text-slate-300 font-semibold text-center">View the fundraising projects that will be closed very soon</div>
      </div>
